...
public class QueryMethodTest {
	...
	@Autowired	//repository 객체를 생성해 줌
...
//				repository.findByTitle("테스트 제목4");
//		
//		log.info("검색 결과");
...
//		Pageable paging = PageRequest.of(0, 10); //오름차순
		...
		log.info("PIZE SIZE " + pageInfo.getSize()); //10(페이지당 데이터수)
		log.info("TOTAL PAGES: " + pageInfo.getTotalPages()); //20(전체 페이지수)
		log.info("TOTAL COUNT: " + pageInfo.getTotalElements()); // 200 (전체 게시글(데이터)수)
//		log.info("CONTENTS: " + pageInfo.getContent()); //저장된 데이터 값 즉:OBJECT
